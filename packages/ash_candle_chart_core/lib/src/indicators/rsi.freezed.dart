...
$RSIConfigCopyWith<RSIConfig> get copyWith => _$RSIConfigCopyWithImpl<RSIConfig>(this as RSIConfig, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RSIConfig&&(identical(other.id, id) || other.id == id)&&(identical(other.period, period) || other.period == period)&&const DeepCollectionEquality().equals(other.dependsOn, dependsOn));
}
...
abstract mixin class $RSIConfigCopyWith<$Res>  {
  factory $RSIConfigCopyWith(RSIConfig value, $Res Function(RSIConfig) _then) = _$RSIConfigCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$RSIConfigCopyWithImpl<$Res>
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _RSIConfig value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _RSIConfig value)  $default,){
final _that = this;
switch (_that) {
case _RSIConfig():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _RSIConfig value)?  $default,){
final _that = this;
switch (_that) {
case _RSIConfig() when $default != null:
return $default(_that);case _:
...
class _RSIConfig implements RSIConfig {
  const _RSIConfig({required this.id, this.period = 14, final  List<String> dependsOn = const []}): _dependsOn = dependsOn;
...
@pragma('vm:prefer-inline')
_$RSIConfigCopyWith<_RSIConfig> get copyWith => __$RSIConfigCopyWithImpl<_RSIConfig>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RSIConfig&&(identical(other.id, id) || other.id == id)&&(identical(other.period, period) || other.period == period)&&const DeepCollectionEquality().equals(other._dependsOn, _dependsOn));
}
...
/// @nodoc
abstract mixin class _$RSIConfigCopyWith<$Res> implements $RSIConfigCopyWith<$Res> {
  factory _$RSIConfigCopyWith(_RSIConfig value, $Res Function(_RSIConfig) _then) = __$RSIConfigCopyWithImpl;
@override @useResult
$Res call({
 String id, int period, List<String> dependsOn
});
...
/// @nodoc
class __$RSIConfigCopyWithImpl<$Res>
    implements _$RSIConfigCopyWith<$Res> {
