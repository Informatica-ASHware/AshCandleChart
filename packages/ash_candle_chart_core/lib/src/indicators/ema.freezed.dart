...
$EMAConfigCopyWith<EMAConfig> get copyWith => _$EMAConfigCopyWithImpl<EMAConfig>(this as EMAConfig, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EMAConfig&&(identical(other.id, id) || other.id == id)&&(identical(other.period, period) || other.period == period)&&const DeepCollectionEquality().equals(other.dependsOn, dependsOn));
}
...
abstract mixin class $EMAConfigCopyWith<$Res>  {
  factory $EMAConfigCopyWith(EMAConfig value, $Res Function(EMAConfig) _then) = _$EMAConfigCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$EMAConfigCopyWithImpl<$Res>
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EMAConfig value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EMAConfig value)  $default,){
final _that = this;
switch (_that) {
case _EMAConfig():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EMAConfig value)?  $default,){
final _that = this;
switch (_that) {
case _EMAConfig() when $default != null:
return $default(_that);case _:
...
class _EMAConfig implements EMAConfig {
  const _EMAConfig({required this.id, this.period = 20, final  List<String> dependsOn = const []}): _dependsOn = dependsOn;
...
@pragma('vm:prefer-inline')
_$EMAConfigCopyWith<_EMAConfig> get copyWith => __$EMAConfigCopyWithImpl<_EMAConfig>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EMAConfig&&(identical(other.id, id) || other.id == id)&&(identical(other.period, period) || other.period == period)&&const DeepCollectionEquality().equals(other._dependsOn, _dependsOn));
}
...
/// @nodoc
abstract mixin class _$EMAConfigCopyWith<$Res> implements $EMAConfigCopyWith<$Res> {
  factory _$EMAConfigCopyWith(_EMAConfig value, $Res Function(_EMAConfig) _then) = __$EMAConfigCopyWithImpl;
@override @useResult
$Res call({
 String id, int period, List<String> dependsOn
});
...
/// @nodoc
class __$EMAConfigCopyWithImpl<$Res>
    implements _$EMAConfigCopyWith<$Res> {
