...
/// The pixel ratio for the exported image. Defaults to 2.0.
 double get pixelRatio;/// Optional watermark text to be displayed on the image.
 String? get watermark;/// Whether the image background should be opaque. Defaults to true.
 bool get opaque;/// The background color for the exported image.
...
@useResult
$Res call({
 double pixelRatio, String? watermark, bool opaque, Color backgroundColor
});
...
/// Create a copy of ExportConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? pixelRatio = null,Object? watermark = freezed,Object? opaque = null,Object? backgroundColor = null,}) {
  return _then(_self.copyWith(
pixelRatio: null == pixelRatio ? _self.pixelRatio : pixelRatio // ignore: cast_nullable_to_non_nullable
as double,watermark: freezed == watermark ? _self.watermark : watermark // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double pixelRatio,  String? watermark,  bool opaque,  Color backgroundColor)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ExportConfig() when $default != null:
return $default(_that.pixelRatio,_that.watermark,_that.opaque,_that.backgroundColor);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double pixelRatio,  String? watermark,  bool opaque,  Color backgroundColor)  $default,) {final _that = this;
switch (_that) {
case _ExportConfig():
return $default(_that.pixelRatio,_that.watermark,_that.opaque,_that.backgroundColor);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double pixelRatio,  String? watermark,  bool opaque,  Color backgroundColor)?  $default,) {final _that = this;
switch (_that) {
case _ExportConfig() when $default != null:
return $default(_that.pixelRatio,_that.watermark,_that.opaque,_that.backgroundColor);case _:
  return null;
...
class _ExportConfig implements ExportConfig {
  const _ExportConfig({this.pixelRatio = 2.0, this.watermark, this.opaque = true, this.backgroundColor = Colors.white});
...
@override@JsonKey() final  bool opaque;
...
/// Create a copy of ExportConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? pixelRatio = null,Object? watermark = freezed,Object? opaque = null,Object? backgroundColor = null,}) {
